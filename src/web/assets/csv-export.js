...
export function buildAnalyticsCsv(data = {}, locale = 'zh') {
  const labels = locale === 'zh' ? { summary: '汇总', metric: '指标', value: '值', daily: '每日趋势', date: '日期', tokens: 'Token', cost: '成本', projects: '项目', project: '项目', models: '模型', model: '模型', sources: '来源', source: '来源', sessions: '热门会话', session: '会话', duration: '活跃分钟', sessionsMetric: '会话数', requestsMetric: '请求数', tokensMetric: 'Token', costMetric: '成本', activeDaysMetric: '活跃天数', cacheEfficiencyMetric: '缓存效率' } : { summary: 'Summary', metric: 'Metric', value: 'Value', daily: 'Daily trends', date: 'Date', tokens: 'Tokens', cost: 'Cost', projects: 'Projects', project: 'Project', models: 'Models', model: 'Model', sources: 'Sources', source: 'Source', sessions: 'Top sessions', session: 'Session', duration: 'Active minutes', sessionsMetric: 'Sessions', requestsMetric: 'Requests', tokensMetric: 'Tokens', costMetric: 'Cost', activeDaysMetric: 'Active days', cacheEfficiencyMetric: 'Cache efficiency' };
