...
const SHELL_COPY_ZH = Object.freeze({
  ...
  'syncCenter.headline.busy': '同步 Worker 忙碌',
  'syncCenter.headline.failed': '最近同步有失败',
  ...
  'syncCenter.reason.cancelling': '已请求取消；后台任务正在释放 Worker 锁并收尾。',
  'syncCenter.reason.failedJob': '最近一次前台 sync job 失败；请查看同步日志后重试。',
  ...
  'syncCenter.action.busy': '已有同步任务持有 Worker 锁。',
  ...
  'shell.explorer.title': 'Cost Explorer',
  'shell.explorer.sub': '按时间粒度、指标、维度与工具过滤做本地切片分析；结果来自后端聚合，不在前端透视原始行。',
  ...
  'shell.explorer.includeOther': '合并 Other',
  'shell.explorer.includeNonTool': '包含非工具',
  'shell.explorer.apply': '运行分析',
  'shell.explorer.reset': '重置',
  'shell.explorer.snapshotDisabled': '离线快照使用导出时捕获的 Explorer 查询',
  'shell.explorer.rowsTitle': '维度排行',
  'shell.explorer.rowsSub': '按当前指标排序，Top N 之外可合并为 Other。',
  'shell.explorer.seriesTitle': '时间序列',
  'shell.explorer.seriesSub': '按所选粒度返回，可用于 snapshot/export 离线查看。',
...
const SHELL_COPY_EN = Object.freeze({
  ...
  'shell.explorer.eyebrow': 'EXPLORER',
  'shell.explorer.title': 'Cost Explorer',
  'shell.explorer.sub': 'Slice local usage by time granularity, metric, dimension and tool filters. Results come from backend aggregation, not frontend raw-row pivoting.',
  ...
  'shell.explorer.granularity': 'Granularity',
  ...
  'shell.explorer.snapshotDisabled': 'Offline snapshots use the Explorer query captured during export',
  'shell.explorer.rowsTitle': 'Dimension ranking',
  'shell.explorer.rowsSub': 'Sorted by the selected metric; rows beyond Top N can be merged into Other.',
  'shell.explorer.seriesTitle': 'Time series',
  'shell.explorer.seriesSub': 'Returned at the selected granularity for offline snapshot/export review.',
  'shell.cost.eyebrow': 'COST',
