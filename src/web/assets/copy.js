  ...
  sections: Object.freeze({
    ...
    insights: Object.freeze({
      ...
      items: Object.freeze({
        ...
        lossy_rebuild: Object.freeze({ label: '数据保留', title: '检测到有损重建风险', evidence: '{source} 缺失 {missingCount} 个源文件，默认保护 {protectedCount} 条已导入事件。', action: '普通同步不会删除已导入历史；重建前请先处理风险来源或明确允许有损重建。' }),
  ...
  sections: Object.freeze({
    ...
    insights: Object.freeze({
      ...
      items: Object.freeze({
        ...
        lossy_rebuild: Object.freeze({ label: 'Data retention', title: 'Lossy rebuild risk detected', evidence: '{source} is missing {missingCount} source files; {protectedCount} imported events are protected by default.', action: 'Ordinary sync keeps imported history. Resolve risky sources before rebuilding or explicitly allow a lossy rebuild.' }),
